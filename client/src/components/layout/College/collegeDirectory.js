                                            ...
                                            this.state.colleges.map((item) => (
                                                <tr role="row" className="odd " key={item._id}>
                                                    ...
                                                    <td className="product-img">
                                                        <img style={{width:'24px',height:'34px'}}
                                                          src={`http://192.46.211.35:5000/public/${item.logo}`} alt="Img placeholder" />
                                                    </td>
                                                    ...
                                                    <td className="product-action"
                                                        onClick={() => this.getCollegeID(item)}>
...
export default connect(mapStateToProps, {getCollegeInfo})(withRouter(collegeDirectory));